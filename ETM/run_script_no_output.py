...
for r in range(num_runs):
  ...
  save_dir = ETM_dir+"/SavedOutput/"+data_name+"/"+dtype+"/topics_"+str(num_topics)+"/runs_"+str(r+1)
  os.makedirs(save_dir,exist_ok=True)
  os.system("nohup python3 main.py  --mode train  --bow_norm 0 --dataset "+dataset_name_ETM+" --data_path "+data_path_ETM+"  --emb_path "+embeddings_path_ETM+"  --num_topics "+str(num_topics)+" --train_embeddings 0 --epochs 1000")
