...
if __name__ == '__main__':
  ...
  variance_x, bs, embedding_tensor_words,emb_size,smoothen,isbn_muz,isbn_x,isbn_phi, "gaussian")
  ...
  os.chdir(home_dir)
  save_dir = home_dir+"/SavedOutput/"+data_name+"/"+dtype+"/topics_"+str(args.num_topics)+"/runs_"+str(args.run)
